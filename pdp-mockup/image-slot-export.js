...
(() => {
  ...
  const stylesheet =
    ...
    // compact hosts (small tiles) have no room for the sub-line or icon
    '.empty .sub{display:var(--slot-sub-display,block)}' +
    '.empty svg{display:var(--slot-icon-display,block)}' +
