...
(() => {
  ...
  const stylesheet =
    ...
    '.frame{position:absolute;inset:0;overflow:hidden;background:var(--slot-surface,rgba(127,127,127,.08))}' +
    ...
    '.ring{position:absolute;inset:0;pointer-events:none;border:var(--slot-ring,1.5px dashed currentColor);' +
